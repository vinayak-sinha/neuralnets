 ...
 * September 25, 2023
 *
 * Reads in a BMP file of any format and outputs the BGR bytes as is.
 *
 * javac BMP2ThreeByte.javaRgbQuad.java
 *
 * Usage: BMP2ThreeByte <infilename.bmp> <outfilename.bin>
 *
...
// The color table
      ...
      BMP2ThreeByte dibdumper = new BMP2ThreeByte(); // needed to get to the byte swapping methods
...
/*
 * Now write out the color bytes as BGR to a disk file.
 *
 */
      try
         {
