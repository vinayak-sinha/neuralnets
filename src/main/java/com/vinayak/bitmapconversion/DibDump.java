 ...
 */
      try
         ...
         bmpInfoHeader_biBitCount = 32;       // 24 bit color image. Changes this number to 32 to write out 32 bit color images

         bmpFileHeader_bfOffBits = 54;        // 54 byte offset for this specific BMP header
         ...
         if (bmpInfoHeader_biBitCount == 32)
            bmpInfoHeader_biSizeImage =  bmpInfoHeader_biWidth * bmpInfoHeader_biHeight * 4;
         else
